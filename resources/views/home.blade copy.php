                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div class="text-slid-box">
                        <div id="offer-box" class="carouselTicker">
                            <ul class="offer-box">
                                <li>
                                    <i class="fab fa-opencart"></i> Madjindo un nouveau produit sur le marche
                                </li>
                                <li>
                                    <i class="fab fa-opencart"></i> Il y'a maintenant plusieurs mois nous nous sommes lancé dans la production,
                                </li>
                                <li>
                                    <i class="fab fa-opencart"></i>  la distribution d'une eau filtré et purifié
                                </li>
                                <li>
                                    <i class="fab fa-opencart"></i> des packs de 400ml disponible
                                </li>
                                <li>
                                    <i class="fab fa-opencart"></i> des packs de 250ml disponibles
                                </li>
                                <li>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-default bootsnav">
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html"><img src="{{asset('images/logomadjindo.png')}}" class="logo" alt=""></a>
                </div>
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                        ...
                        <li class="nav-item"><a class="nav-link" href="service.html">Nos Service</a></li>
        ...
        <div class="main-instagram owl-carousel owl-theme">
            <div class="item">
                <div class="ins-inner-box">
                    <img src="{{asset('images/thies2.jpg')}}" alt="" />
                    <div class="hov-in">
            ...
            <div class="item">
                <div class="ins-inner-box">
                    <img src="{{asset('images/thies3.jpg')}}" alt="" />
                    <div class="hov-in">
                        <a href="#"><i class="fab fa-instagram"></i></a>
                    </div>
                </div>
            ...
            <div class="item">
                <div class="ins-inner-box">
                    <img src="{{asset('images/thies4.jpg')}}" alt="" />
                    <div class="hov-in">
                        <a href="#"><i class="fab fa-instagram"></i></a>
                    </div>
                </div>
            ...
            <div class="item">
                <div class="ins-inner-box">
                    <img src="{{asset('images/thies5.jpg')}}" alt="" />
                    <div class="hov-in">
                        <a href="#"><i class="fab fa-instagram"></i></a>
                    </div>
                </div>
            ...
            <div class="item">
                <div class="ins-inner-box">
                    <img src="{{asset('images/thies6.jpg')}}" alt="" />
                    <div class="hov-in">
                        <a href="#"><i class="fab fa-instagram"></i></a>
                    </div>
                </div>
            ...
            <div class="item">
                <div class="ins-inner-box">
                    <img src="{{asset('images/thies7.jpg')}}" alt="" />
                    <div class="hov-in">
                        <a href="#"><i class="fab fa-instagram"></i></a>
                    </div>
                </div>
            ...
            <div class="item">
                <div class="ins-inner-box">
                    <img src="{{asset('images/thies8.jpg')}}" alt="" />
                    <div class="hov-in">
                        <a href="#"><i class="fab fa-instagram"></i></a>
                    </div>
                </div>
            ...
            <div class="item">
                <div class="ins-inner-box">
                    <img src="{{asset('images/madjindoThies.jpg')}}" alt="" />
                    <div class="hov-in">
                        <a href="#"><i class="fab fa-instagram"></i></a>
                    </div>
                </div>
